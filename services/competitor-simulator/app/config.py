"""Configuration for the competitor simulator service."""
...
class Settings(BaseSettings):
    """Typed simulator settings loaded from environment variables."""
    ...
    log_level: str = "INFO"
    healthcheck_file: str = "/tmp/competitor-simulator.healthy"
